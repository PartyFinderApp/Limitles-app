...
function HomeContainer() {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="gap-8 divrounded lg:bg-[#F3F3F3] bg-[#F3F3F3]  dark:bg-gray-900 rounded-[45px] flex flex-col items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 lg:flex-row lg:items-stretch lg:justify-center lg:px-32 lg:mt-24">
        <div className="lg:w-1/2 lg:mr-8">
          <h2 className="mb-12 lg:mt-24 lg:text-[69px] text-3xl leading-normal tracking-tight font-extrabold text-black lg:text-black text-black dark:text-white">
            {t("home.text1")}
          </h2>

          <div className="flex flex-col lg:flex-row lg:justify-start lg:items-center">
            <div className="relative">
              <span className="absolute bottom-0 text-gray-500 transform -translate-y-1/2 lg:bottom-2 left-3 top-1/2 ">
                <MapPin size={20} />
              </span>
              <input
                type="text"
                placeholder={t("faq.searchPlaceholderdeux")}
                className="pl-10 w-full lg:w-auto mb-4 lg:mb-0 lg:mr-4 px-6 lg:px-10 py-4 text-gray-900 placeholder-gray-500 border border-gray-300 lg:rounded-[10px] bg-gray-50 focus:outline-none focus:ring focus:ring-indigo-200 rounded-lg"
              />
            </div>
            <div className="relative">
              <span className="absolute bottom-0 text-gray-500 transform -translate-y-1/2 lg:bottom-2 left-3 top-1/2 ">
              ...
              <input
                type="text"
                placeholder={t("faq.searchPlaceholderTrois")}
                className="pl-10  w-full lg:w-auto mb-4 lg:mb-0 lg:mr-4 px-6 lg:px-10 py-4 text-gray-900 placeholder-gray-500 border border-gray-300 lg:rounded-[10px] bg-gray-50 focus:outline-none focus:ring focus:ring-indigo-200 rounded-lg"
              />
            </div>
            <button className="relative w-full px-6 py-6 font-semibold text-white bg-gray-800 rounded-full lg:w-auto lg:rounded-full hover:bg-gray-700 focus:outline-none">
          ...
          <div className="flex items-center justify-center mt-12">
            <p className="text-2xl text-black dark:text-white lg:text-black lg:hidden">
              {t("home.middletext")}
            </p>
          </div>
        ...
        <div className="lg:w-1/2">
          <img
            ...
            src={require("../assets/firstapp.png")}
        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div class="mt-4 lg:mt-0 lg:col-span-5 lg:flex">
            <img
              ...
              height={270}
              width={270}
              src={require("../assets/Hosting/Color=Deep Purple.png")}
              alt="mockup"
            />
          </div>
        </div>
