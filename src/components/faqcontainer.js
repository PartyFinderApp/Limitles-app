        ...
        <div className="p-4 mb-8">
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full px-10 py-4 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-[10px] bg-gray-50 pl-14 focus:outline-none focus:ring focus:ring-indigo-200"
            />
          </div>
